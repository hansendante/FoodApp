...
<div class="container-xl ml-1">
    <div class="row">
        <div class="col">
            <button class="btn btn-primary mt-3" data-bs-toggle="modal" data-bs-target="#data_makanan"><i class="far fa-plus-square"></i> Tambah Data Makanan</button>
            <h1 class="mt-2">Daftar Makanan</h1>
            ...
            <table class="table">
                <thead>
                    <tr>
                        ...
                        <th style="text-align:right" scope="col" scope="col">Harga Bahan</th>
