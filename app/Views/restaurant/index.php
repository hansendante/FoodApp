...
<div class="container-xl ml-1">
    <div class="row">
        <div class="col">
            <button class="btn btn-primary mt-3" data-bs-toggle="modal" data-bs-target="#data_makanan"><i class="far fa-plus-square"></i> Tambah Data Restaurant</button>
            <h1 class="mt-2">Daftar Restaurant</h1>
            ...
            <table class="table">
                <thead>
                    <tr>
                        ...
                        <th scope="col">Jenis Restaurant</th>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Form Tambah Data Restaurant</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="/restaurant/save" method="post" enctype="multipart/form-data">
                    <?= csrf_field(); ?>
                    <div class="row mb-3">
